...
#include "AsyncAwaitActorLeaveView.generated.h"

UCLASS()
class GTCORE_API UAsyncAwaitActorLeaveView final : public UExtendedAsyncAction
{
	GENERATED_BODY()
	
public:

	/* Waits for the actor to leave the player view.
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Actor", meta = (BlueprintInternalUseOnly = "true", DefaultToSelf = "Target", AutoCreateRefTerm = "TraceCheckParams", AdvancedDisplay = "TraceCheckParams, WaitTime, CheckInterval", DisplayName = "Await Actor Leave View (Async)", Keywords = "Await Wait Actor View Leave"))
		static UAsyncAwaitActorLeaveView* AwaitActorLeaveView(AActor* Target, const float MaxDistance = 5000.0f,
